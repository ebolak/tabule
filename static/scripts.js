...
$(document).ready(function () {
    ...
    socket.on(line_name + '/actualValues', function (msg) {
        if (!(jsonEqual(msg, memActualValues))) {
            ...
            $('#bekido').text(computeBekido(msg.payload['ok'], msg.payload['counterTactTime']));
    ...
    $('#settingsShift-shiftENOff').on('click', function (e) {
        ...
        msg.payload = {
            'value': ['0'],
            'nodeId': 'ns=3;s=\"settingsShift\".\"' + settingsShift_shiftSelect + '\".\"shiftEN\"',
            'datatypeName': 'Int32',
            'name': 'shiftEN'
        };
        socket.emit('publish', JSON.stringify(msg));
    ...
    $('#settingsShift-break1ENOff').on('click', function (e) {
        ...
        msg.payload = {
            'value': ['0'],
            'nodeId': 'ns=3;s=\"settingsShift\".\"' + settingsShift_shiftSelect + '\".\"break1EN\"',
            'datatypeName': 'Int32',
            'name': 'break1EN'
        };
        socket.emit('publish', JSON.stringify(msg));
    ...
    $('#settingsShift-break2ENOff').on('click', function (e) {
        ...
        msg.payload = {
            'value': ['0'],
            'nodeId': 'ns=3;s=\"settingsShift\".\"' + settingsShift_shiftSelect + '\".\"break2EN\"',
            'datatypeName': 'Int32',
            'name': 'break2EN'
        };
        socket.emit('publish', JSON.stringify(msg));
    ...
    $('#settingsShift-break3ENOff').on('click', function (e) {
        ...
        msg.payload = {
            'value': ['0'],
            'nodeId': 'ns=3;s=\"settingsShift\".\"' + settingsShift_shiftSelect + '\".\"break3EN\"',
            'datatypeName': 'Int32',
            'name': 'break3EN'
        };
        socket.emit('publish', JSON.stringify(msg));
    ...
    $('#settingsShift-break4ENOff').on('click', function (e) {
        ...
        msg.payload = {
            'value': ['0'],
            'nodeId': 'ns=3;s=\"settingsShift\".\"' + settingsShift_shiftSelect + '\".\"break4EN\"',
            'datatypeName': 'Int32',
            'name': 'break4EN'
        };
        socket.emit('publish', JSON.stringify(msg));
    ...
    $('#settingsShift-break5ENOff').on('click', function (e) {
        ...
        msg.payload = {
            'value': ['0'],
            'nodeId': 'ns=3;s=\"settingsShift\".\"' + settingsShift_shiftSelect + '\".\"break5EN\"',
            'datatypeName': 'Int32',
            'name': 'break5EN'
        };
        socket.emit('publish', JSON.stringify(msg));
    ...
    $('#settingsShift-save-time-input').on('click', function (e) {
        ...
        if (time_ms <= 86399999) {
            ...
            msg.payload = {
                'value': [time_ms],
                'nodeId': 'ns=3;s=\"settingsShift\".\"' + settingsShift_shiftSelect + '\".\"' + timeInputSource + '\"',
                'datatypeName': 'UInt32',
