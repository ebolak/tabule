...
SECURITY_MSG_PASSWORD_RESET_REQUEST = (
    ('Odkaz pro obnovení hesla byl zaslán na %(email)s'), 'info')
SECURITY_MSG_PASSWORD_RESET = (
    ('Vaše heslo bylo změněno a přihlášení proběhlo automaticky'), 'success')
...
SECURITY_MSG_PASSWORD_INVALID_LENGTH = (
    ('Heslo musí obsahovat alespoň 6 znaků'), 'error')
SECURITY_MSG_PASSWORD_IS_THE_SAME = (
    ('Vaše nové heslo se musí lišit od předchozího hesla'), 'error')
...
MQTT_TOPICS = {
    ...
    LINE_NAME + "/previousValues": {"namespace": NAME_SPACE, "room": None},
    LINE_NAME + "/prePreviousValues": {"namespace": NAME_SPACE, "room": None},
